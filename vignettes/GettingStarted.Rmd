...
```{r, message=FALSE}
library(MIRA)
library(GenomicRanges) # for the `resize` and `width` functions
data("exampleRegionSet", package="MIRA")
data("exampleBSDT", package="MIRA")
