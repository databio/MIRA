...
First, let's load the libraries and read in the data files. For the libraries and the sample annotation file which was included in the built-in package data:
...
bigBinDT1 = merge(bigBinDT1, exampleAnnoDF2, all.x=TRUE)
```
...
bigBinDT2 = merge(bigBinDT2, exampleAnnoDF2, all.x=TRUE)
```
