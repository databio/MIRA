...
If you are running the actual samples on your own device, you can skip the following step. Otherwise, let's load the binned methylation data that would have been obtained by the previous step.

```{r, eval = TRUE}
# loading "bigBinDT1" object from data included with MIRA package
...
```{r, eval = TRUE}
# loading "bigBinDT2" object from data included with MIRA package
